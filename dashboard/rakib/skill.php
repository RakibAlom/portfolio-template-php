      ...
      <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          	<div class="sl-page-title">
          		<h5 class="card-body-title">All Skill <a href="new-skill.php" class="btn btn-sm btn-primary float-right">New Skill</a></h5>
				...
				<?php while($result = mysqli_fetch_assoc($run)) { ?>
					<tr>
						...
						<td><img src="img/skill/<?php echo $result['logo']; ?>" alt=""></td>
						<td>
						...
						<td>
							<a href="edit-skill.php?id=<?php echo $result['id']; ?>" class="btn btn-sm btn-primary"><i class="fa fa-pencil"></i></a>
